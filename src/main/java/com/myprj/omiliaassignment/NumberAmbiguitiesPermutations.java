...
public class NumberAmbiguitiesPermutations {
    ...
    public LinkedHashMap<Integer, List<String>> digitsCombinationsList(String str) {
    ...
    public List<String> phoneNumberPermutationsList(LinkedHashMap<Integer, List<String>> digitsCombinations) {
    ...
    public void findPermutations(int i, String str, int mapSize, List<List<String>> digits, List<String> result) {
        if (i >= mapSize) {
